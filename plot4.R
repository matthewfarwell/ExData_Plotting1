...
plot(hpcdates$Date_and_Time, hpcdates$Global_active_power, type = "l", xlab = "", ylab = "Global Active Power")
...
legend("topright", c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), lty = 1, col = c("grey25", "red", "blue"), box.lty = 0)

plot(hpcdates$Date_and_Time, hpcdates$Voltage, type = "l", xlab = "datetime", ylab = "Voltage")

plot(hpcdates$Date_and_Time, hpcdates$Global_reactive_power, type = "l", xlab = "datetime", ylab = "Global_reactive_power")
